...
An extension of the `random walk` is a [heat map](https://en.wikipedia.org/wiki/Heat_map)https://en.wikipedia.org/wiki/Heat_map. Essentially every time a location (or data point) is touched, increase the value by 1. This represents how "hot" that data item is.
